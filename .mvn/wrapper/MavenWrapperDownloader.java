...
public class MavenWrapperDownloader {
	...
	private static final String DEFAULT_DOWNLOAD_URL = "https://repo.maven.apache.org/maven2/io/takari/maven-wrapper/"
                                                       + MavenWrapperDownloader.WRAPPER_VERSION + "/maven-wrapper-" + MavenWrapperDownloader.WRAPPER_VERSION + ".jar";
	...
	public static void main(final String[] args) {
		...
		if (mavenWrapperPropertyFile.exists()) {
			...
			try {
				...
				url = mavenWrapperProperties.getProperty(MavenWrapperDownloader.PROPERTY_NAME_WRAPPER_URL, url);
			} catch (final IOException e) {
				System.out.println("- ERROR loading '" + MavenWrapperDownloader.MAVEN_WRAPPER_PROPERTIES_PATH + "'");
			} finally {
				try {
		...
		final File outputFile = new File(baseDirectory.getAbsolutePath(), MavenWrapperDownloader.MAVEN_WRAPPER_JAR_PATH);
